...
ip -6 rule add iif ens34 table 104
ip -6 rule add iif ens35 table 102

ip -6 route add 3000::2/128 encap seg6local action End dev ens35 table 104
ip -6 route add 3000::2/128 encap seg6local action End dev ens34 table 102
ip -6 route add 3000::4 via 2000:2002::1004
ip -6 route add 3000::1 via 2000:2001::1001
